...
tokenizer.pad_token = tokenizer.eos_token  # Fixes pad_token error
tokenizer.padding_side = "right"

# Configuración 4bit si QLoRA, o normal si LoRA
if args.mode == "qlora":
...
# Target modules por defecto para CodeLlama/Mistral/Falcon/CodeGen (ajusta según modelo si hace falta)
if "codegen" in args.model_name.lower():
    # CodeGen typical modules
...
def format_prompt(example):
    # Puedes personalizar el prompt aquí. Ejemplo formato Alpaca:
    return tokenizer(
        f"### Instruction:\n{example['instruction']}\n### Input:\n{example['input']}\n### Response:\n{example['output']}",
        truncation=True,
        padding="max_length",
